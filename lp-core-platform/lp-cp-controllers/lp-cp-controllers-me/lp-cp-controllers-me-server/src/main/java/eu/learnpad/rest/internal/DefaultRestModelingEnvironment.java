...
import eu.learnpad.rest.RestModelingEnvironment;

@Component
@Named("eu.learnpad.rest.internal.DefaultRestModelingEnvironment")
public class DefaultRestModelingEnvironment implements XWikiRestComponent,
		RestModelingEnvironment {
	@Override
