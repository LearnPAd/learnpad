...
public class ScoreUpdateEvent extends AbstractEvent {
	...
	public ScoreUpdateEvent(Long timestamp, String simulationsessionid,
			List<String> involvedusers, String modelsetid,
			Map<String, Object> simulationSessionData,
			String processartifactid, String user, Long scoreUpdated) {
		super(EventType.SCORE_UPDATE, timestamp, simulationsessionid,
				involvedusers, modelsetid, simulationSessionData);
		this.processartifactid = processartifactid;
		this.updatedScore = scoreUpdated;
		this.user = user;
	}
	...
	public String toString() {
		return super.toString() + " processartifactid=" + processartifactid
				+ " user=" + user + " updatedScore=" + updatedScore;
	}
}