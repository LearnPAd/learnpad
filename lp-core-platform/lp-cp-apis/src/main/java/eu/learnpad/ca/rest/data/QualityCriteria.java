...
public class QualityCriteria {
	...
	public String toString() {
		return "QualityCriteria [simplicity=" + simplicity + ", nonAmbiguity=" + nonAmbiguity + ", contentClarity="
				+ contentClarity + ", presentationClarity=" + presentationClarity + ", completeness=" + completeness
