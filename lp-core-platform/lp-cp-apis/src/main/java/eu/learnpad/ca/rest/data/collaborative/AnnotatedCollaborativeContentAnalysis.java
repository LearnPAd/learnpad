...
@XmlType(name = "", propOrder = { "collaborativeContent", "annotations", "overallQuality", "overallQualityMeasure",
...
public class AnnotatedCollaborativeContentAnalysis {
	...
	public String toString() {
		return "ContentAnalysis [ type=" + type + ", id=" + id + ", collaborativeContent=" + collaborativeContent
				+ ", annotations=" + annotations + ", overallQuality=" + overallQuality + ", overallQualityMeasure="
				+ overallQualityMeasure + ", overallRecommendations=" + overallRecommendations + "]\n";
	}
