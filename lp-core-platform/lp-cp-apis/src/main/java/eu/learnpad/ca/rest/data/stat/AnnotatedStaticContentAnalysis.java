...
@XmlType(name = "", propOrder = { "staticContent", "annotations", "overallQuality", "overallQualityMeasure",
...
public class AnnotatedStaticContentAnalysis {
	...
	public String toString() {
		return "ContentAnalysis [ type=" + type + ", id=" + id + ", staticContent=" + staticContent + ", annotations="
				+ annotations + ", overallQuality=" + overallQuality + ", overallQualityMeasure="
