...
public class DifficultJargon  extends Thread implements AnalysisInterface{ 
	...
	public DifficultJargon(CollaborativeContentAnalysis cca,
			Language lang) {
		this.language=lang;
	...
	private void checkUnclearAcronym(StaticContentAnalysis staticContentInput2) {
		...
		annotatedStaticContent.setType("Simplicity DifficultJargon");
