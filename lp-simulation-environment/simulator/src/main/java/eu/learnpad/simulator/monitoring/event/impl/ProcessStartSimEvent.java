 ...
 *
 */
public class ProcessStartSimEvent extends AbstractSimEvent {

	public ProcessInstanceData processInstance;

	public ProcessStartSimEvent(Long timestamp, String simulationsessionid,
	...
	public SimEventType getType() {
		return SimEventType.PROCESS_START;
	}
