 ...
 *
 */
public class TaskStartSimEvent extends AbstractSimEvent {

	public final LearnPadTask task;

	public TaskStartSimEvent(Long timestamp, String simulationsessionid,
	...
	public SimEventType getType() {
		return SimEventType.TASK_START;
	}
