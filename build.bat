...
IF DEFINED CATALINA_BASE (
if exist %__CATALINA__WEB__%\uicontentanalysiscomponent.war (	del /S /F /A %__CATALINA__WEB__%\uicontentanalysiscomponent.war)
if exist %__CATALINA__WEB__%\uicontentanalysiscomponent	    ( rmdir  %__CATALINA__WEB__%\uicontentanalysiscomponent /s /q)
call mvn clean
...
xcopy /y target\uicontentanalysiscomponent.war %__CATALINA__WEB__%
