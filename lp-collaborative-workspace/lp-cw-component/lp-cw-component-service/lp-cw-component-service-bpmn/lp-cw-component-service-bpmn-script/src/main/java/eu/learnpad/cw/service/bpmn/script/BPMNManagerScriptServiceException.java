...
public class BPMNManagerScriptServiceException extends Exception
{
    /**
     ...
     */
    public BPMNManagerScriptServiceException(String message)
    {
        super(message);
    }
     ...
     */
    public BPMNManagerScriptServiceException(String message, Throwable throwable)
    {
