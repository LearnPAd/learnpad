...
public class LearnPAdManagerException extends Exception
{
    /**
     ...
     */
    public LearnPAdManagerException(String message)
    {
        super(message);
    }
     ...
     */
    public LearnPAdManagerException(String message, Throwable throwable)
    {
