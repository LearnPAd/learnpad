...
public class BPMNFlowNodeManagerScriptServiceException extends Exception
{
    /**
     ...
     */
    public BPMNFlowNodeManagerScriptServiceException(String message)
    {
        super(message);
    }
     ...
     */
    public BPMNFlowNodeManagerScriptServiceException(String message, Throwable throwable)
    {
