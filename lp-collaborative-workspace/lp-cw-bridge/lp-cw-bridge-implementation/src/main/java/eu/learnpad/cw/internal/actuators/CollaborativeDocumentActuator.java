...
public class CollaborativeDocumentActuator extends SimpleEventActuator{

	
	public CollaborativeDocumentActuator(UICWBridge cwBridge) {			
		this(cwBridge,null);
	}

	public CollaborativeDocumentActuator(UICWBridge cwBridge, Logger logger) {			
	...
	protected EntityReference targetEntityReference(String optionalLabel) {
		EntityReference reference = new DocumentReference(this.xcontext.getMainXWiki(),LPCodeLabels.getCLASSES_SPACE(),LPCodeLabels.getCOLLABORATIVE_DOCUMENT_CLASS());
		return reference;
	}
