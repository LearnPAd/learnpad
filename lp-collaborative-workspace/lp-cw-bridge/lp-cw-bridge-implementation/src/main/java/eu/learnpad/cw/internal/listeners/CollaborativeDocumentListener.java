...
import eu.learnpad.cw.internal.actuators.CollaborativeDocumentActuator;
...
public class CollaborativeDocumentListener extends SimpleEventListener{
	...
	public void onEvent(Event event, Object source, Object data) {
		 CollaborativeDocumentActuator actuator = new CollaborativeDocumentActuator(this.cwBridge, this.logger);
