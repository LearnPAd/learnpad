...
<asm version="1.0" name="0">
	<cp>
		<constant value="Relational2Class"/>
		...
		<constant value="A.__matchRelationalModel2ClassModel():V"/>
		<constant value="A.__matchTable2Class():V"/>
		<constant value="A.__matchColumn2Attribute():V"/>
		<constant value="__exec__"/>
		<constant value="RelationalModel2ClassModel"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyRelationalModel2ClassModel(NTransientLink;):V"/>
		...
		<constant value="__matchRelationalModel2ClassModel"/>
		...
		<constant value="__applyRelationalModel2ClassModel"/>
