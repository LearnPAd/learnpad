 ...
 * <ul>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getId <em>Id</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getFullName <em>Full Name</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getWiki <em>Wiki</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getSpace <em>Space</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getName <em>Name</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getParentId <em>Parent Id</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getAuthorName <em>Author Name</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getXwikiRelativeUrl <em>Xwiki Relative Url</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getXwikiAbsoluteUrl <em>Xwiki Absolute Url</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getTranslations <em>Translations</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.PageSummaryImpl#getSyntax <em>Syntax</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
