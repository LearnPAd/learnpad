 ...
 * <ul>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getPageId <em>Page Id</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getWiki <em>Wiki</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getSpace <em>Space</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getName <em>Name</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getMajorVersion <em>Major Version</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getMinorVersion <em>Minor Version</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getModifier <em>Modifier</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getModifierName <em>Modifier Name</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.HistorySummaryImpl#getComment <em>Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
