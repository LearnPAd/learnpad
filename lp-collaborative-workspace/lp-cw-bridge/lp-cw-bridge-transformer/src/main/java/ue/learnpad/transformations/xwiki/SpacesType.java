 ...
 * <ul>
 *   <li>{@link ue.learnpad.transformations.xwiki.SpacesType#getSpace <em>Space</em>}</li>
 * </ul>
 * </p>
 *
 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getSpacesType()
...
public interface SpacesType extends LinkCollection {
	 ...
	 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getSpacesType_Space()
