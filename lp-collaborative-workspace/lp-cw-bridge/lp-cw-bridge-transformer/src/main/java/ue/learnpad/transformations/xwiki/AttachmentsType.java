 ...
 * <ul>
 *   <li>{@link ue.learnpad.transformations.xwiki.AttachmentsType#getAttachment <em>Attachment</em>}</li>
 * </ul>
 * </p>
 *
 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getAttachmentsType()
...
public interface AttachmentsType extends LinkCollection {
	 ...
	 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getAttachmentsType_Attachment()
