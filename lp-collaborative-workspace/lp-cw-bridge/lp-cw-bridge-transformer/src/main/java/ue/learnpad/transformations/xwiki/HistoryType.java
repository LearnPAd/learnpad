 ...
 * <ul>
 *   <li>{@link ue.learnpad.transformations.xwiki.HistoryType#getHistorySummary <em>History Summary</em>}</li>
 * </ul>
 * </p>
 *
 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getHistoryType()
...
public interface HistoryType extends LinkCollection {
	 ...
	 * The list contents are of type {@link ue.learnpad.transformations.xwiki.HistorySummary}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getHistoryType_HistorySummary()
