/**
 */
package ue.learnpad.transformations.xwiki.impl;
 ...
 * <ul>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getAttachment <em>Attachment</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getAttachments <em>Attachments</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getClasses <em>Classes</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getComments <em>Comments</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getHistory <em>History</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getObject <em>Object</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getObjects <em>Objects</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getObjectSummary <em>Object Summary</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getPage <em>Page</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getPages <em>Pages</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getSearchResult <em>Search Result</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getSearchResults <em>Search Results</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getSpace <em>Space</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getSpaces <em>Spaces</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getSyntaxes <em>Syntaxes</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getTranslations <em>Translations</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getWiki <em>Wiki</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getWikis <em>Wikis</em>}</li>
 *   <li>{@link ue.learnpad.transformations.xwiki.impl.DocumentRootImpl#getXwiki <em>Xwiki</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	 ...
	 * @generated
	 */
	public EList<ue.learnpad.transformations.xwiki.Class> getClass_() {
	 ...
	 * @generated
	 */
	public EList<ue.learnpad.transformations.xwiki.Object> getObject() {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case XwikiPackage.DOCUMENT_ROOT__CLASS:
				getClass_().clear();
				getClass_().addAll((Collection<? extends ue.learnpad.transformations.xwiki.Class>)newValue);
				return;
			case XwikiPackage.DOCUMENT_ROOT__CLASSES:
				getClasses().clear();
			...
			case XwikiPackage.DOCUMENT_ROOT__OBJECT:
				getObject().clear();
				getObject().addAll((Collection<? extends ue.learnpad.transformations.xwiki.Object>)newValue);
				return;
			case XwikiPackage.DOCUMENT_ROOT__OBJECTS:
				getObjects().clear();
