 ...
 * <ul>
 *   <li>{@link ue.learnpad.transformations.xwiki.PagesType#getPageSummary <em>Page Summary</em>}</li>
 * </ul>
 * </p>
 *
 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getPagesType()
...
public interface PagesType extends LinkCollection {
	 ...
	 * The list contents are of type {@link ue.learnpad.transformations.xwiki.PageSummary}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getPagesType_PageSummary()
