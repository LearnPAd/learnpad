 ...
 * <ul>
 *   <li>{@link ue.learnpad.transformations.xwiki.WikisType#getWiki <em>Wiki</em>}</li>
 * </ul>
 * </p>
 *
 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getWikisType()
...
public interface WikisType extends LinkCollection {
	 ...
	 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getWikisType_Wiki()
