 ...
 * <ul>
 *   <li>{@link ue.learnpad.transformations.xwiki.Syntaxes#getSyntax <em>Syntax</em>}</li>
 * </ul>
 * </p>
 *
 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getSyntaxes()
...
public interface Syntaxes extends LinkCollection {
	 ...
	 * @see ue.learnpad.transformations.xwiki.XwikiPackage#getSyntaxes_Syntax()
