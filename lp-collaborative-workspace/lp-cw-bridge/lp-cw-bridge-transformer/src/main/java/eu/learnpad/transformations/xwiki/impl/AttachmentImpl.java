 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getId <em>Id</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getSize <em>Size</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getPageId <em>Page Id</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getPageVersion <em>Page Version</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getMimeType <em>Mime Type</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getAuthorName <em>Author Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getDate <em>Date</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getXwikiRelativeUrl <em>Xwiki Relative Url</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.AttachmentImpl#getXwikiAbsoluteUrl <em>Xwiki Absolute Url</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
