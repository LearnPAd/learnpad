 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.WikisType#getWiki <em>Wiki</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getWikisType()
...
public interface WikisType extends LinkCollection {
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getWikisType_Wiki()
