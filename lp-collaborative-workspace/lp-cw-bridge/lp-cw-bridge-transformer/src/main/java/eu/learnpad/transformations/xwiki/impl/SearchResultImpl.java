 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getType <em>Type</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getId <em>Id</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getPageFullName <em>Page Full Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getWiki <em>Wiki</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getSpace <em>Space</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getPageName <em>Page Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getAuthorName <em>Author Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getClassName <em>Class Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getObjectNumber <em>Object Number</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getFilename <em>Filename</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getScore <em>Score</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.SearchResultImpl#getObject <em>Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SearchResultImpl extends LinkCollectionImpl implements SearchResult {
	 ...
	 * @ordered
	 */
	protected eu.learnpad.transformations.xwiki.Object object;
	 ...
	 * @generated
	 */
	public eu.learnpad.transformations.xwiki.Object getObject() {
		return object;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetObject(eu.learnpad.transformations.xwiki.Object newObject, NotificationChain msgs) {
		eu.learnpad.transformations.xwiki.Object oldObject = object;
		object = newObject;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setObject(eu.learnpad.transformations.xwiki.Object newObject) {
		if (newObject != object) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case XwikiPackage.SEARCH_RESULT__SCORE:
				...
				return;
			case XwikiPackage.SEARCH_RESULT__OBJECT:
				setObject((eu.learnpad.transformations.xwiki.Object)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case XwikiPackage.SEARCH_RESULT__SCORE:
				...
				return;
			case XwikiPackage.SEARCH_RESULT__OBJECT:
				setObject((eu.learnpad.transformations.xwiki.Object)null);
				return;
		}
