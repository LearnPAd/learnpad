 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.ObjectsType#getObjectSummary <em>Object Summary</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getObjectsType()
...
public interface ObjectsType extends LinkCollection {
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getObjectsType_ObjectSummary()
