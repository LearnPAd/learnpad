 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.ado.impl.MODELTypeImpl#getMODELATTRIBUTES <em>MODELATTRIBUTES</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.MODELTypeImpl#getINSTANCE <em>INSTANCE</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.MODELTypeImpl#getCONNECTOR <em>CONNECTOR</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.MODELTypeImpl#getApplib <em>Applib</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.MODELTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.MODELTypeImpl#getLibtype <em>Libtype</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.MODELTypeImpl#getModeltype <em>Modeltype</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.MODELTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.MODELTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
