 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.ado.MODELGROUPType#getMODELREFERENCE <em>MODELREFERENCE</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.MODELGROUPType#getMODELGROUP <em>MODELGROUP</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.MODELGROUPType#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see eu.learnpad.transformations.ado.AdoPackage#getMODELGROUPType()
...
public interface MODELGROUPType extends EObject {
	 ...
	 * @see eu.learnpad.transformations.ado.AdoPackage#getMODELGROUPType_MODELREFERENCE()
	 ...
	 * The list contents are of type {@link eu.learnpad.transformations.ado.MODELGROUPType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.learnpad.transformations.ado.AdoPackage#getMODELGROUPType_MODELGROUP()
	 * @model containment="true"
	 ...
	 * @see #setName(String)
	 * @see eu.learnpad.transformations.ado.AdoPackage#getMODELGROUPType_Name()
	...
	/**
	 * Sets the value of the '{@link eu.learnpad.transformations.ado.MODELGROUPType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
