 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.AttachmentsType#getAttachment <em>Attachment</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getAttachmentsType()
...
public interface AttachmentsType extends LinkCollection {
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getAttachmentsType_Attachment()
