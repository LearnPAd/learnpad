 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.SearchResultsType#getSearchResult <em>Search Result</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.SearchResultsType#getTemplate <em>Template</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getSearchResultsType()
...
public interface SearchResultsType extends LinkCollection {
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getSearchResultsType_SearchResult()
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getSearchResultsType_Template()
	...
	/**
	 * Sets the value of the '{@link eu.learnpad.transformations.xwiki.SearchResultsType#getTemplate <em>Template</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
