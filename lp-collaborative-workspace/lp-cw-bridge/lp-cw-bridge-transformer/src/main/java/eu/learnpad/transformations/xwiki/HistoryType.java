 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.HistoryType#getHistorySummary <em>History Summary</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getHistoryType()
...
public interface HistoryType extends LinkCollection {
	 ...
	 * The list contents are of type {@link eu.learnpad.transformations.xwiki.HistorySummary}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getHistoryType_HistorySummary()
