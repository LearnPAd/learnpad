 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.ado.MODELGROUPSType#getMODELGROUP <em>MODELGROUP</em>}</li>
 * </ul>
 *
 * @see eu.learnpad.transformations.ado.AdoPackage#getMODELGROUPSType()
...
public interface MODELGROUPSType extends EObject {
	 ...
	 * @see eu.learnpad.transformations.ado.AdoPackage#getMODELGROUPSType_MODELGROUP()
