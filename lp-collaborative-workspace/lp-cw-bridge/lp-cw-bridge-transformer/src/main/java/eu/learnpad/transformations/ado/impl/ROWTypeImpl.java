 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ROWTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ROWTypeImpl#getATTRIBUTE <em>ATTRIBUTE</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ROWTypeImpl#getINTERREF <em>INTERREF</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ROWTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ROWTypeImpl#getNumber <em>Number</em>}</li>
 * </ul>
 *
 * @generated
 */
