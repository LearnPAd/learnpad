 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getId <em>Id</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getGuid <em>Guid</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getPageId <em>Page Id</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getPageVersion <em>Page Version</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getWiki <em>Wiki</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getSpace <em>Space</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getPageName <em>Page Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getPageAuthor <em>Page Author</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getPageAuthorName <em>Page Author Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getClassName <em>Class Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.ObjectSummaryImpl#getHeadline <em>Headline</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
