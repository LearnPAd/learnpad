 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.TagsType#getTag <em>Tag</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getTagsType()
...
public interface TagsType extends LinkCollection {
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getTagsType_Tag()
