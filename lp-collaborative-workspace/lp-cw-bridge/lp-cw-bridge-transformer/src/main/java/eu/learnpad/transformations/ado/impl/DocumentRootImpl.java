...
import eu.learnpad.transformations.ado.ADOXMLType;
import eu.learnpad.transformations.ado.APPLICATIONMODELSType;
import eu.learnpad.transformations.ado.APPLICATIONMODELType;
import eu.learnpad.transformations.ado.ATTRIBUTEPROFILESType;
import eu.learnpad.transformations.ado.ATTRIBUTEPROFILEType;
import eu.learnpad.transformations.ado.ATTRIBUTEType;
import eu.learnpad.transformations.ado.ATTRPROFDIRType;
import eu.learnpad.transformations.ado.AdoPackage;
import eu.learnpad.transformations.ado.CONNECTORType;
import eu.learnpad.transformations.ado.DocumentRoot;
import eu.learnpad.transformations.ado.FROMType;
import eu.learnpad.transformations.ado.INSTANCEType;
import eu.learnpad.transformations.ado.INTERREFType;
import eu.learnpad.transformations.ado.IREFType;
import eu.learnpad.transformations.ado.MODELATTRIBUTESType;
import eu.learnpad.transformations.ado.MODELGROUPSType;
import eu.learnpad.transformations.ado.MODELGROUPType;
import eu.learnpad.transformations.ado.MODELREFERENCEType;
import eu.learnpad.transformations.ado.MODELSType;
import eu.learnpad.transformations.ado.MODELType;
import eu.learnpad.transformations.ado.RECORDType;
import eu.learnpad.transformations.ado.ROWType;
 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getADOXML <em>ADOXML</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getAPPLICATIONMODEL <em>APPLICATIONMODEL</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getAPPLICATIONMODELS <em>APPLICATIONMODELS</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getATTRIBUTE <em>ATTRIBUTE</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getATTRIBUTEPROFILE <em>ATTRIBUTEPROFILE</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getATTRIBUTEPROFILES <em>ATTRIBUTEPROFILES</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getATTRPROFDIR <em>ATTRPROFDIR</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getCONNECTOR <em>CONNECTOR</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getFROM <em>FROM</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getINSTANCE <em>INSTANCE</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getINTERREF <em>INTERREF</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getIREF <em>IREF</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getMODEL <em>MODEL</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getMODELATTRIBUTES <em>MODELATTRIBUTES</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getMODELGROUP <em>MODELGROUP</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getMODELGROUPS <em>MODELGROUPS</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getMODELREFERENCE <em>MODELREFERENCE</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getMODELS <em>MODELS</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getRECORD <em>RECORD</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getROW <em>ROW</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.DocumentRootImpl#getTO <em>TO</em>}</li>
 * </ul>
 *
 * @generated
 */
