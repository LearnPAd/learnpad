 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.TOTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.TOTypeImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TOTypeImpl extends MinimalEObjectImpl.Container implements TOType {
	/**
	...
	protected EClass eStaticClass() {
		return AdoPackage.Literals.TO_TYPE;
	}
	...
	public void setClass(String newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoPackage.TO_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setInstance(String newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoPackage.TO_TYPE__INSTANCE, oldInstance, instance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdoPackage.TO_TYPE__CLASS:
				return getClass_();
			case AdoPackage.TO_TYPE__INSTANCE:
				return getInstance();
		}
