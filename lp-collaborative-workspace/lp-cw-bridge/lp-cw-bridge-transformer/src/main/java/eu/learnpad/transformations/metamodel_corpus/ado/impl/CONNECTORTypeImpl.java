 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.CONNECTORTypeImpl#getFROM <em>FROM</em>}</li>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.CONNECTORTypeImpl#getTO <em>TO</em>}</li>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.CONNECTORTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.CONNECTORTypeImpl#getATTRIBUTE <em>ATTRIBUTE</em>}</li>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.CONNECTORTypeImpl#getRECORD <em>RECORD</em>}</li>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.CONNECTORTypeImpl#getINTERREF <em>INTERREF</em>}</li>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.CONNECTORTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link eu.learnpad.transformations.metamodel_corpus.ado.impl.CONNECTORTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
