 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ATTRIBUTEPROFILETypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ATTRIBUTEPROFILETypeImpl#getATTRIBUTE <em>ATTRIBUTE</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ATTRIBUTEPROFILETypeImpl#getRECORD <em>RECORD</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ATTRIBUTEPROFILETypeImpl#getINTERREF <em>INTERREF</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ATTRIBUTEPROFILETypeImpl#getApplib <em>Applib</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ATTRIBUTEPROFILETypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ATTRIBUTEPROFILETypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.ATTRIBUTEPROFILETypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
