 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.Syntaxes#getSyntax <em>Syntax</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getSyntaxes()
...
public interface Syntaxes extends LinkCollection {
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getSyntaxes_Syntax()
