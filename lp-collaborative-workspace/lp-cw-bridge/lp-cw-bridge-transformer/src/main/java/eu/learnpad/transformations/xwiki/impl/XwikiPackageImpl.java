...
public class XwikiPackageImpl extends EPackageImpl implements XwikiPackage {
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, eu.learnpad.transformations.xwiki.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Id(), theXMLTypePackage.getString(), "id", null, 1, 1, eu.learnpad.transformations.xwiki.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, eu.learnpad.transformations.xwiki.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Property(), this.getProperty(), null, "property", null, 0, -1, eu.learnpad.transformations.xwiki.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(objectEClass, eu.learnpad.transformations.xwiki.Object.class, "Object", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getObject_Property(), this.getProperty(), null, "property", null, 0, -1, eu.learnpad.transformations.xwiki.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
