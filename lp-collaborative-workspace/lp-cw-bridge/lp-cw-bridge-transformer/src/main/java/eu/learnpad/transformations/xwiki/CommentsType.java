 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.CommentsType#getComment <em>Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getCommentsType()
...
public interface CommentsType extends LinkCollection {
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getCommentsType_Comment()
