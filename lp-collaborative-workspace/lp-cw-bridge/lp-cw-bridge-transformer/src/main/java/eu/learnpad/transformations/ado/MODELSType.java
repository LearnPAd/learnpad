 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.ado.MODELSType#getMODEL <em>MODEL</em>}</li>
 * </ul>
 *
 * @see eu.learnpad.transformations.ado.AdoPackage#getMODELSType()
...
public interface MODELSType extends EObject {
	 ...
	 * The list contents are of type {@link eu.learnpad.transformations.ado.MODELType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.learnpad.transformations.ado.AdoPackage#getMODELSType_MODEL()
