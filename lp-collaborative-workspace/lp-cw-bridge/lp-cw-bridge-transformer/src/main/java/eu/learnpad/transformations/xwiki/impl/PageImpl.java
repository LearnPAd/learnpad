 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getMajorVersion <em>Major Version</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getMinorVersion <em>Minor Version</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getCreator <em>Creator</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getCreatorName <em>Creator Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getModifier <em>Modifier</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getModifierName <em>Modifier Name</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link eu.learnpad.transformations.xwiki.impl.PageImpl#getContent <em>Content</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
