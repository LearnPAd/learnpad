...
public class XwikiSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case XwikiPackage.CLASS: {
				eu.learnpad.transformations.xwiki.Class class_ = (eu.learnpad.transformations.xwiki.Class)theEObject;
			...
			case XwikiPackage.OBJECT: {
				eu.learnpad.transformations.xwiki.Object object = (eu.learnpad.transformations.xwiki.Object)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(eu.learnpad.transformations.xwiki.Class object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseObject(eu.learnpad.transformations.xwiki.Object object) {
		return null;
	}
