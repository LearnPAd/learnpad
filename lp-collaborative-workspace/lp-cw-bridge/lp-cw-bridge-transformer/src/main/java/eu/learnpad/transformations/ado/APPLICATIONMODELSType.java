 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.ado.APPLICATIONMODELSType#getAPPLICATIONMODEL <em>APPLICATIONMODEL</em>}</li>
 * </ul>
 *
 * @see eu.learnpad.transformations.ado.AdoPackage#getAPPLICATIONMODELSType()
...
public interface APPLICATIONMODELSType extends EObject {
	 ...
	 * The list contents are of type {@link eu.learnpad.transformations.ado.APPLICATIONMODELType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.learnpad.transformations.ado.AdoPackage#getAPPLICATIONMODELSType_APPLICATIONMODEL()
