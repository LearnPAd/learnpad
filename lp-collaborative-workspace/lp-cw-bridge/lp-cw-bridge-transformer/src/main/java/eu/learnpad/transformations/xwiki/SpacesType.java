 ...
 * <ul>
 *   <li>{@link eu.learnpad.transformations.xwiki.SpacesType#getSpace <em>Space</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getSpacesType()
...
public interface SpacesType extends LinkCollection {
	 ...
	 * @see eu.learnpad.transformations.xwiki.XwikiPackage#getSpacesType_Space()
