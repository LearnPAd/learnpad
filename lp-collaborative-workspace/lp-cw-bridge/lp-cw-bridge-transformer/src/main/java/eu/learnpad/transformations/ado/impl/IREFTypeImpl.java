 ...
 * </p>
 * <ul>
 *   <li>{@link eu.learnpad.transformations.ado.impl.IREFTypeImpl#getTclassname <em>Tclassname</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.IREFTypeImpl#getTmodelname <em>Tmodelname</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.IREFTypeImpl#getTmodeltype <em>Tmodeltype</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.IREFTypeImpl#getTmodelver <em>Tmodelver</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.IREFTypeImpl#getTobjname <em>Tobjname</em>}</li>
 *   <li>{@link eu.learnpad.transformations.ado.impl.IREFTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
