...
import eu.learnpad.dash.CoreFacade;
 ...
 */
public class DASHCoreFacadeRestResource implements CoreFacade {

	public DASHCoreFacadeRestResource() {
		this("localhost", 8080);
	}

	public DASHCoreFacadeRestResource(String coreFacadeHostname,
